...
public class Usuario {
    ...
    public List<Notificacion> getListNotificaciones() { return listNotificaciones; }
    public void setListNotificaciones(List<Notificacion> listNotificaciones) { this.listNotificaciones = listNotificaciones; }

    public List<Reporte> getListReportes() { return listReportes; }
    public void setListReportes(List<Reporte> listReportes) { this.listReportes = listReportes; }

    public List<Vuelo> getListVuelos() { return listVuelos; }
    public void setListVuelos(List<Vuelo> listVuelos) { this.listVuelos = listVuelos; }
}
